...
for row in first_three_placements.iterrows():
    ...
    first_two_placement_prob.append(totalProb)
...
print(first_two_placement_prob)
print(final_VP)
correlation = np.corrcoef(np.array(first_two_placement_prob),np.array(final_VP))
print(correlation)
